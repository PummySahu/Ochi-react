...
const Footer = () => {
  return (
    <div className='w-full h-screen p-20 pb-10 flex'>
        <div className='w-1/2 flex flex-col justify-between h-full '>
            <div>
                <h1 className='text-8xl font-bold tracking-tight leading-none  '>EYE-</h1>
                <h1 className='uppercase text-8xl font-bold tracking-tight leading-none  '>opening</h1>
            </div>
        ...
        <div className='w-1/2 relative flex flex-col items-left justify-between text-base'>
            <h1 className='text-[6vw] tracking-tight font-bold uppercase leading-none'>Presentations</h1>
              ...
              <div className='flex justify-between w-full'>
                ...
                <h1>202-1965 W 4th Ave <br /> Vancouver, Canada</h1><br />
                <h1>30 Chukarina St <br />Lviv, Ukraine</h1>
                </div>
                <div>
                  <h1>M:</h1>
                  <h1>Home</h1>
             ...
             <div className='flex w-full justify-between items-center text-lg text-zinc-400'>
